...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--latents_train_path', default="../pretrained/ffhq/train_faces.pt", type=str, help="The latents for the training")
		self.parser.add_argument('--latents_test_path', default="../pretrained/ffhq/test_faces.pt", type=str, help="The latents for the validation")
		...
		self.parser.add_argument('--anchor_lambda', default=100.0, type=float, help='Entanglement loss multiplier factor')
